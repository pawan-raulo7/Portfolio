...
const projects = [
  ...
  },
  {
    ...
    category: "Web Development",
    description: "Meetly is an AI-powered meeting management platform that automatically generates meeting summaries, extracts key insights, and creates actionable tasks from meeting transcripts, helping teams stay organized and productive.",
    technologies: [],
    image: "/images/meetly.png",
    link: "https://github.com/pawan-raulo7/MeetLy.git"
  },
    {
    title: "Customer Agent",
    category: "Agentic AI",
    description: " An multi – agent AI customer support system with specialized agents for customer interactions,governance monitoring, and high – risk decision workflows.",
    technologies: [],
    image: "/images/customer.png",
    link: "https://github.com/pawan-raulo7/Customer_Support.git"
  },
    {
    title: "Web - Design",
    category: "UI/UX",
    description: "A modern freelance UI/UX portfolio website concept focused on showcasing design work, services, and client testimonials through a clean and intuitive user experience.",
    technologies: [],
    image: "/images/freelance.png",
    link: "https://github.com/pawan-raulo7/Craftrix.git"
  },
    {
    title: "Telegram Bot",
    category: "Bot Development",
    description: "A Telegram bot designed to automate user interactions, streamline workflows, and deliver instant responses through a simple and intuitive chat-based interface.",
    technologies: [],
    image: "/images/bot.png",
    link: "https://github.com/pawan-raulo7/Telegram-bot.git"
  },
];
